...
try {
    ...
    $update_quantity_sql = "Update market_place.super_admin set FName = '".$SCHAfirstName."',LName = '".$SCHAlastName."',Mobile = '".$SCHAmobile."',Mail_id = '".$SCHAmailId."',Address = '".$SCHAaddress."' where User_name = '".$User_name."'";
