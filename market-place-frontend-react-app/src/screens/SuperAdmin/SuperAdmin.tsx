...
import { super_admin_data } from '../../API/static_data'
...
export default function SuperAdmin(props: any) {
    ...
    useEffect(() => {
        ...
        if (!(window.localStorage.getItem('user_object')) || window.localStorage.getItem('user_object') && JSON.parse(window.localStorage.getItem('user_object') || '')?.user_type != 'super_adm') {
            console.log('in if');
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        // axios.get(`https://jxp9700.uta.cloud/index.php`)
        axios.post('https://wdm.final.phase.rxg8255.uta.cloud/getAllschAdmin')
          .then((result: any)  => {
            const schoolAdmin = result.data;
            console.log(schoolAdmin);
            setschoolAdmin(schoolAdmin);
          });
      }, []);
    ...
    const[inputsSa, setInputsSa] = useState({})
    ...
    const handleChange2 = (event: any) => {
        const name = event.target.name;
        const value = event.target.value;
        setInputsSa(values => ({...values,[name]:value }));
    }
        ...
        const onSubmitThirdModal = (event: any) => {
            event.preventDefault();
        ...
        const onSubmitFourthModal = (event: any) => {
            event.preventDefault();
            axios.post(`https://wdm.final.phase.rxg8255.uta.cloud/api/superAdminDetailsUpdate.php`, inputsSa)
            /*{
                "User_name": data['StuserName'],
                "StfirstName": data['StfirstName'],
                "StlastName": data['StlastName'],
        ...
        <div>
                        ...
                        <Typography id="modal-modal-title" variant="h6" component="h4">
                            ...
                            <div>
                                    ...
                                    <div style={{ textAlign: 'center' }} className="col-2">
                                        <h4>Super Admin First Name : {userObject?.data && userObject?.data[0].FName}</h4>
                                        <h4>Super Admin Last Name : {userObject?.data && userObject?.data[0].LName}</h4>
                                        <h4>Super Admin Mail ID : {userObject?.data && userObject?.data[0].Mail_id}</h4>
                                        <h4>Super Admin Mobile : {userObject?.data && userObject?.data[0].Mobile}</h4>
                                        <h4>Super Admin Address : {userObject?.data && userObject?.data[0].Address}</h4>
                                        <h4>Super Admin User Name : {userObject?.data && userObject?.data[0].User_name}</h4>
                    ...
                    >
                        ...
                        <Typography id="modal-modal-title" variant="h6" component="h4">
                            ...
                            <div>
                            {
                                schoolAdmin.map((schoolAdmin_data) => (
                                    <div style={{ textAlign: 'center' }} className="col-2">
                                        <h4>School Admin Id : {schoolAdmin_data['s_id']}</h4>
                                        <h4>School Admin First Name : {schoolAdmin_data['FName']}</h4>
                                        <h4>School Admin Last Name : {schoolAdmin_data['LName']}</h4>
                                        <h4>School Admin Mail ID : {schoolAdmin_data['Mail_id']}</h4>
                                        <h4>School Admin Mobile : {schoolAdmin_data['Mobile']}</h4>
                                        <h4>School Admin Address : {schoolAdmin_data['Address']}</h4>
                                        <h4>School Name : {schoolAdmin_data['school_name']}</h4>
                                        <h4>School Admin User Name : {schoolAdmin_data['User_name']}</h4>
                        ...
                        <Typography > 
                            <div>
                            <form onSubmit={onSubmitThirdModal}>
                                <table cellSpacing="1">
                                    <tbody>
                                    <tr>
                                            <th>
                                            ...
                                            <td>
                                            <input 
                                                type='text' name='SCHAuserName' onChange={handleChange1} required
                                            />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                            <input 
                                                type='text' name='SCHAfirstName' onChange={handleChange1} required
                                            />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                            <input 
                                                    type='text' name='SCHAlastName' onChange={handleChange1} required
                                                />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                            <input 
                                                type='text' name='SCHAmailId' onChange={handleChange1} required
                                            />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                            <input 
                                                type='text' name='SCHAmobile' onChange={handleChange1} required 
                                            />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                            <input 
                                                type='text' name='SCHAaddress' onChange={handleChange1} required 
                                            />
                                            </td>
                                        </tr>
                                        <tr>
            ...
            <div className="body_wrapper">
                <div className="header">
                    <div className="row" style={{ alignItems: 'center' }}>
                        <div className="col-1">
                            <img src={super_admin_data['profile_image']} height="400px" />
                            <h3>{fname} {lname} (Super Admin) <br />{Mobile}<br />{userName}</h3>
                            <p></p>
                    ...
                    <div className="row">
                        {
                            businessOwner.map((bo_object) => (
                                <div className="col-4">
                                    <img src={super_admin_data['bop_image']} />
                ...
                <div className="small-container">
                    <h2 className="title">Manage School Admins</h2>
                    <div className="row">
                        <div className="person_search_input">
                            <input type="text" placeholder="Search School Admins..." name="search2" />
                            <button type="submit"></button>
                        </div>
                    </div>
                    <div className="row">
                        {
                            schoolAdmin.map((school_admin_object) => (
                                <div className="col-4">
                                    <img src={super_admin_data['school_admin_image']} />
                                    <h4>{school_admin_object['FName']} {school_admin_object['LName']}</h4>
                                    <button onClick={handleopenThirdModal}>
                                        Moderate
                                    </button>
                                </div>
                            ))
                    ...
                    <div className="row">
                        {
                            students.map((student_object) => (
                                <div className="col-4">
                                    <img src={super_admin_data['student_image']} />
                ...
                <div className="my-chat">
                    <NavLink to={'/chat'} title='Super Admin Chat'><img src={chatImage} /></NavLink>
                </div>
                <br />
            </div>
            <Footer />
